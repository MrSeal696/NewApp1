<img width="1280" height="676" alt="изображение" src="https://github.com/user-attachments/assets/818d2bd1-dfe9-4c73-8366-0401aa315dd5" /># NewApp1 – Приложение для управления задачами

Это мой проект на **.NET MAUI**, в котором реализованы функционал управления задачами с локальным хранением, API и полноценной навигацией.
